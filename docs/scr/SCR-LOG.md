...
| SCR-008 | MCP operator gateway (agentic command & control) as new increment M1f | Implemented (spec level) | 2026-07-20 | SDP, ICD, SRS, SVS, SRF, CLAUDE.md | #78 (SCR + SDP), #80 (ICD Issue 6 §8.4 + SRS + SVS) |
