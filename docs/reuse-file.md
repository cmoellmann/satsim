...
| MCP Java SDK (mcp-core, mcp-json-jackson2) | 2.0.0 | runtime (`mcp-gateway` only) | MIT | Notice retention on distribution. Transitives: Reactor Core 3.7.0 + reactive-streams 1.0.4 (Apache-2.0 / MIT-0), SLF4J API 2.0.16 (MIT), Jackson annotations 2.20 / databind+core 2.20.1 / dataformat-yaml 2.18.3 (Apache-2.0), networknt json-schema-validator 2.0.0 (Apache-2.0), ethlo itu 1.14.0 (Apache-2.0), snakeyaml 2.3 (Apache-2.0) — all permissive | 2026-07-20, C. Möllmann (rule-8 license situation presented in SCR-008/PR #78; approval via merge of the introducing PR) |
