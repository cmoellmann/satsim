# Fixture SVS (deliberately defective set for SIM-TC-014)

| ID | Requirements | Title | Type | Expected result |
|---|---|---|---|---|
| SIM-TC-901 | SIM-REQ-FIX-001 | Implemented case | A | fixture |
| SIM-TC-902 | SIM-REQ-FIX-001 | In-scope case without implementing test | A | fixture |
